...
module JapaneseAddressParser
  module CsvParser
    ...
    def call
      data = CSV.table('lib/japanese_address_parser/data/japanese-addresses.csv', header_converters: proc { |h| HEADER_MAP[h] })
      ...
      prefectures.each do |prefecture, cities|
        ...
        cities.each do |city, towns|
          CSV.open("lib/japanese_address_parser/data/#{prefecture.formatted_code}-#{city.formatted_code}.csv", 'w') do |csv|
