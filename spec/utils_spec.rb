...
::RSpec.describe(::JapaneseAddressParser::Utils) do
  ...
  describe '.remove_extra_from_machi_aza' do
    ...
    let(:machi_aza) do
      ::JapaneseAddressParser::Data::SingleMachiAza.from_json(
        'machiaza_id' => '0001',
        'oaza_cho' => '道玄坂',
        'chome' => '一丁目',
        'rsdt' => true,
