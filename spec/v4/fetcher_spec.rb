...
::RSpec.describe(::JapaneseAddressParser::V4::Fetcher) do
  include ::WebMock::API
  ...
  describe 'file access (local path)' do
    before { ::JapaneseAddressParser::V4.configure { |c| c.japanese_addresses_api = fixtures_dir } }
  ...
  describe 'file:// scheme' do
    before { ::JapaneseAddressParser::V4.configure { |c| c.japanese_addresses_api = "file://#{fixtures_dir}" } }
  ...
  describe 'unknown URL scheme' do
    before { ::JapaneseAddressParser::V4.configure { |c| c.japanese_addresses_api = 'ftp://example.com/api' } }
  ...
  describe 'http access' do
    ...
    it 'appends the geolonia-api-key query when configured' do
      ::JapaneseAddressParser::V4.configure { |c| c.geolonia_api_key = 'secret-key' }
