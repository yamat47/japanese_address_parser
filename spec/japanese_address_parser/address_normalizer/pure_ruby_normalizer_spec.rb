  ...
  describe '.call' do
    context '正常なケース' do
      it '東京都渋谷区恵比寿を正しく解析する' do
        ...
        expect(result).to(include('pref' => '東京都', 'city' => '渋谷区', 'town' => '恵比寿一丁目', 'level' => 3))
      ...
      it '正規化が必要な住所を正しく処理する' do
        ...
        expect(result).to(include('pref' => '東京都', 'city' => '渋谷区'))
    ...
    context 'エラーケース' do
      it '空文字列の場合' do
        ...
        expect(result).to(include('pref' => '', 'city' => '', 'town' => '', 'level' => 0))
      end
    ...
    context 'レベル別の解析' do
      it '都道府県のみ特定できる場合はレベル1' do
        ...
        expect(result).to(include('pref' => '東京都', 'city' => '', 'town' => '', 'level' => 1))
      end

      it '市区町村まで特定できる場合はレベル2' do
        result = described_class.call('東京都渋谷区')

        expect(result).to(include('pref' => '東京都', 'city' => '渋谷区', 'town' => '', 'level' => 2))
      end
