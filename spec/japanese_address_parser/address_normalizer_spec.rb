...
::RSpec.describe(::JapaneseAddressParser::AddressNormalizer) do
  describe '.call' do
    context 'Pure Ruby実装が正常に動いているとき' do
    ...
    context 'Pure Ruby実装が例外を吐いたとき' do
      before do
        allow(::JapaneseAddressParser::AddressNormalizer::PureRubyNormalizer).to(receive(:call).and_raise(::StandardError))
      end
